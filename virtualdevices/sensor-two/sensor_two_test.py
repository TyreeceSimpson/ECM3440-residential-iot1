...
def test_connect():
    ...
    when(app.IoTHubDeviceClient).create_from_connection_string('HostName=iothub-devices.azure-devices.net;DeviceId=sensor-two;SharedAccessKey=BUccsKmIiv6KVZb0bZzktg72wHl39eqxDPc2FwGzqok=').thenReturn(MockClient)
